...
import android.training.demoapp.FetchAddressTask.FetchAddressTask;
...
import android.training.demoapp.Receiver.InternetReceiver;
import android.training.demoapp.ServicesAPI.EstacionesProvinciasService;
import android.training.demoapp.ServicesAPI.ProvinciasServices;
...
public class SyncActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        shIsProvincia = mPreferences.getString("isProvincia", shProvincia);
    ...
    private void cargarProvinciasDB(){
       // if (shProvincia == null) {
            //Log.d(LOG_TAG, "sinc provincias");
            /**
             * Recibe WS Provincias
             */
            new ProvinciasServices(new ProvinciasServices.ProvinciasServicesInterface() {
                ...
                public void getResponse(List<Provincia> response) {
                    ...
                    preferencesEditor.putBoolean("is_provincias", true);
...
//        } else {
//            Log.d(LOG_TAG, "no sinc provincias");
//            //irListado();
//        }
    }
    ...
    private void cargarProvicasSpiner(){
        provinciaViewModel.getAllProvincias().observe(this, new Observer<List<Provincia>>() {
            ...
            public void onChanged(@Nullable final List<Provincia> provincias) {
                ...
                //ArrayAdapter adapter = new ArrayAdapter(activity, android.R.layout.simple_list_item_1, provincias);

                spinner.setAdapter(adapter);
                //spinner.setSelection(shPosicionProvincia);
                ...
                spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                    public void onItemSelected(AdapterView<?> parent, View view, int pos, long id) {
                        if (spinnerTouched) {
                            ...
                            SharedPreferences.Editor preferencesEditor = mPreferences.edit();
                            preferencesEditor.putString("IdProvincia", provinciaSpinerSeleccionada.getIDPovincia());
                            preferencesEditor.apply();
    ...
    private void volcarEstacionesProvincaDB(){
        ...
        new EstacionesProvinciasService(new EstacionesProvinciasService.EstacionesProvinciasServicesInterface() {
            ...
            public void getResponse(EstacionesServicio response) {
                ...
                SharedPreferences.Editor preferencesEditor = mPreferences.edit();
                preferencesEditor.putString("fecha", estacionesServicio.getFecha());
                preferencesEditor.apply();
...
private float calcularDistancia(LatLng ubi) {
    float resultadoDistancia;
    LatLng latLngEstacionServicio = ubi;
    ...
    public void onTaskCompleted(String result) {
        ...
        mPreferences = getSharedPreferences(sharedPrefFile, MODE_PRIVATE);
        SharedPreferences.Editor preferencesEditor = mPreferences.edit();
        preferencesEditor.putString("IdProvincia", result);
        preferencesEditor.apply();
